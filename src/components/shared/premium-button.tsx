...
export function PremiumButton({
  ...
  return (
    ...
    >
      {/* Inner Square */}
      <div className="pointer-events-none absolute left-1 top-1/2 flex h-12 w-12 -translate-y-1/2 items-center justify-center rounded-xl bg-primary text-black transition-all duration-500 ease-out group-hover:left-[calc(100%-3.25rem)] group-active:left-[calc(100%-3.25rem)] z-1">
        <svg
          className="size-10"
          width="40"
          height="40"
      ...
      <span
        className={cn(
          "relative pl-15 pr-5 text-sm tracking-wide transition-transform duration-500 ease-out group-hover:-translate-x-10 group-active:-translate-x-10",
